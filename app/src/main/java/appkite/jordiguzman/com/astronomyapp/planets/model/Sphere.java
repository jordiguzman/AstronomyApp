package appkite.jordiguzman.com.astronomyapp.planets.model;
...
import appkite.jordiguzman.com.astronomyapp.planets.util.Maths;
...
public class Sphere {
    ...
    private static final int VERTEX_MAGIC_NUMBER = 15;

    /** Each vertex is a 2D coordinate. */
    private static final int NUM_FLOATS_PER_VERTEX = 13;
    ...
    private final List<float[]> mTexture = new ArrayList<>();
    ...
    public Sphere(final int depth, final float radius) {
        ...
        this.mTotalNumStrips = Maths.power(d - 1) * VERTEX_MAGIC_NUMBER;
        final int numVerticesPerStrip = Maths.power(d) * 3;
        final double altitudeStepAngle = Maths.ONE_TWENTY_DEGREES / Maths.power(d);
